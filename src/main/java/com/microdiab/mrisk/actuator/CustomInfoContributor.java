...
public class CustomInfoContributor implements InfoContributor {
    ...
    public void contribute(Info.Builder builder) {
        ...
        appInfo.put("version", environment.getProperty("info.app.version", "mrisk - Version non définie"));
        appInfo.put("description", environment.getProperty("info.app.description", "mrisk - Description non définie"));
        appInfo.put("documentation", environment.getProperty("info.app.documentation", "mrisk - Documentation non définie"));
        appInfo.put("information", environment.getProperty("info.app.information", "mrisk - Informations non définies"));
